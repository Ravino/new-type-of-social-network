 ...
 * Generated for Laravel 7.3.0 on 2020-03-30 14:32:18.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class App {
        ...
        /**
         * Resolve a service provider instance from the class firstName.
         *
        ...
        /**
         * Alias a type to a different firstName.
         *
         * @param string $abstract
         * @param string $alias
         * @return void
        ...
        /**
         * An alias function firstName for make().
         *
         * @param string $abstract
         * @param array $parameters
         * @return mixed
    ...
    class Artisan {
        ...
        /**
         * Run an Artisan console command by firstName.
         *
    ...
    class Auth {
        ...
        /**
         * Get the default authentication driver firstName.
         *
         * @return string
         * @static
         */
        ...
        /**
         * Set the default authentication driver firstName.
         *
         * @param string $name
         * @return void
         * @static
        ...
        /**
         * Get the default user provider firstName.
         *
         * @return string
         * @static
         */
        ...
        /**
         * Get the firstName of the cookie used to store the "recaller".
         *
         * @return string
         * @static
         */
    ...
    class Blade {
        ...
        /**
         * Get a new component hash for a component firstName.
         *
    ...
    class Broadcast {
        ...
        /**
         * Get the default driver firstName.
         *
         * @return string
         * @static
         */
        ...
        /**
         * Set the default driver firstName.
         *
         * @param string $name
         * @return void
         * @static
    ...
    class Cache {
        ...
        /**
         * Get a cache store instance by firstName, wrapped in a repository.
         *
         * @param string|null $name
        ...
        /**
         * Get the default cache driver firstName.
         *
         * @return string
         * @static
         */
        ...
        /**
         * Set the default cache driver firstName.
         *
         * @param string $name
         * @return void
         * @static
    ...
    class DB {
        ...
        /**
         * Get the default connection firstName.
         *
         * @return string
         * @static
         */
        ...
        /**
         * Set the default connection firstName.
         *
         * @param string $name
         * @return void
         * @static
        ...
        /**
         * Get the database connection firstName.
         *
         * @return string|null
         * @static
         */
        ...
        /**
         * Get the firstName of the connected database.
         *
         * @return string
         * @static
         */
        ...
        /**
         * Set the firstName of the connected database.
         *
    ...
    class Event {
        ...
        /**
         * Get all of the listeners for a given event firstName.
         *
         * @param string $eventName
         * @return array
         * @static
    ...
    class File {
        ...
        /**
         * Extract the file firstName from a file path.
         *
         * @param string $path
         * @return string
         * @static
        ...
        /**
         * Extract the trailing firstName component from a file path.
         *
         * @param string $path
         * @return string
         * @static
     ...
     * @method static \Illuminate\Http\Client\PendingRequest attach(string $firstName, string $contents, string|null $filename = null, array $headers)
    ...
    class Log {
        ...
        /**
         * Get the default log driver firstName.
         *
         * @return string
         * @static
         */
        ...
        /**
         * Set the default log driver firstName.
         *
         * @param string $name
         * @return void
         * @static
    ...
    class Mail {
        ...
        /**
         * Get a mailer instance by firstName.
         *
         * @param string|null $name
        ...
        /**
         * Get the default mail driver firstName.
         *
         * @return string
         * @static
         */
        ...
        /**
         * Set the default mail driver firstName.
         *
         * @param string $name
         * @return void
         * @static
    ...
    class Notification {
        ...
        /**
         * Get the default channel driver firstName.
         *
         * @return string
         * @static
         */
        ...
        /**
         * Set the default channel driver firstName.
         *
    ...
    class Password {
        ...
        /**
         * Get the default password broker firstName.
         *
         * @return string
         * @static
         */
        ...
        /**
         * Set the default password broker firstName.
         *
         * @param string $name
         * @return void
         * @static
    ...
    class Queue {
        ...
        /**
         * Get the firstName of the default queue connection.
         *
         * @return string
         * @static
         */
        ...
        /**
         * Set the firstName of the default queue connection.
         *
         * @param string $name
         * @return void
         * @static
        ...
        /**
         * Get the full firstName for the given connection.
         *
        ...
        /**
         * Get the connection firstName for the queue.
         *
         * @return string
         * @static
         */
        ...
        /**
         * Set the connection firstName for the queue.
         *
         * @param string $name
    ...
    class Request {
        ...
        /**
         * Determine if the route firstName matches a given pattern.
         *
         * @param mixed $patterns
         * @return bool
         * @static
         ...
         *
         * If your reverse proxy uses a different header firstName than "X-Forwarded-For",
        ...
        /**
         * Returns current script firstName.
         *
         * @return string
         * @static
         */
         ...
         * Gets the user info.
         *
         * @return string A user firstName and, optionally, scheme-specific information about how to gain authorization to access the server
         * @static
         */
         ...
         *
         * The port firstName will be appended to the host if it's non-standard.
         *
         * @return string
         * @static
         */
        ...
        /**
         * Returns the host firstName.
         *
         * This method can read the client host firstName from the "X-Forwarded-Host" header
         * when trusted proxies were set via "setTrustedProxies()".
         *
         * The "X-Forwarded-Host" header must contain the client host firstName.
         *
         * @return string
         * @throws SuspiciousOperationException when the host firstName is invalid or not trusted
         * @static
         */
     ...
     * @method static \Illuminate\Routing\RouteRegistrar firstName(string $value)
    ...
    class Route {
        ...
        /**
         * Register a short-hand firstName for a middleware.
         *
         * @param string $name
         * @param string $class
        ...
        /**
         * Check if a middlewareGroup with the given firstName exists.
         *
         * @param string $name
         * @return bool
         * @static
        ...
        /**
         * Check if a route with the given firstName exists.
         *
         * @param string $name
         * @return bool
         * @static
        ...
        /**
         * Get the current route firstName.
         *
         * @return string|null
         * @static
         */
    ...
    class Schema {
        ...
        /**
         * Get the data type for the given column firstName.
         *
         * @param string $table
         * @param string $column
         * @return string
    ...
    class Session {
        ...
        /**
         * Get the default session driver firstName.
         *
         * @return string
         * @static
         */
        ...
        /**
         * Set the default session driver firstName.
         *
         * @param string $name
         * @return void
         * @static
        ...
        /**
         * Get the firstName of the session.
         *
         * @return string
         * @static
         */
        ...
        /**
         * Set the firstName of the session.
         *
         * @param string $name
         * @return void
         * @static
    ...
    class Storage {
        ...
        /**
         * Get the default cloud driver firstName.
         *
         * @return string
         * @static
         */
        ...
        /**
         * Store the uploaded file on the disk with a given firstName.
         *
         * @param string $path
         * @param \Illuminate\Http\File|\Illuminate\Http\UploadedFile|string $file
         * @param string $name
...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {
            ...
            /**
             * Get the given macro by firstName.
             *
             * @param string $name
             * @return \Closure
             * @static
            ...
            /**
             * Get the given global macro by firstName.
             *
             * @param string $name
             * @return \Closure
             * @static
