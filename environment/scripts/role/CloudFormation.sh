...
# make variables
ROLE_NAME="${INPUT_ROLE}DeployRole"    #ROLE_NAME="{INPUT_ROLE}"DeployRole/${STACK_NAME}" 
echo "ROLE_NAME=${ROLE_NAME}"
ROLE_POLICY_NAME=${ROLE_NAME}"Policy"
echo "ROLE_POLICY_NAME=${ROLE_POLICY_NAME}"
ROLE_ASSUME_POLICY_NAME="assume-role-policy/${INPUT_ROLE}"
echo "ROLE_ASSUME_POLICY_NAME=${ROLE_ASSUME_POLICY_NAME}"
ROLE_DEPLOY_POLICY_NAME="deploy-role-policy/${INPUT_ROLE}"
