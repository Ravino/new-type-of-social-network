...
<template>
    <div id="communityUserActions" class="bg-white-br20 mb-4 py-3 px-4">
        <button @click="onAddPostClick" type="button" class="btn btn-primary btn-block mx-auto px-3 py-2 text-uppercase text-center rounded-pill">
            Написать сообщение
        </button>

        <button type="button"
                @click="onNotificationEnableClick"
                class="d-none btn btn-link btn-block w-100 mb-2 text-black-50 text-left">
