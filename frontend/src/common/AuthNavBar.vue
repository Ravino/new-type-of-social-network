                ...
                <div class="col-sm-2 col-md-1 col-lg-2 px-0 profile-menu">
                    ...
                    <div class="profile-menu-item p-0 m-0 d-flex align-items-center position-relative">
                        ...
                        <div class="dropdown-menu dropdown-menu-right py-3 px-3" aria-labelledby="dropdownMenuUser">
                            <router-link to="/switch-language" tag="div"
                                         class="nav-item border-bottom">
                                <a class="dropdown-item px-0 py-1" href="#">Моя страница</a>
                            </router-link>
                            <router-link to="/switch-language" tag="div" class="nav-item">
                                <a class="dropdown-item px-0 py-1" href="#">Редактировать</a>
                            </router-link>
                            <router-link to="/switch-language" tag="div" class="nav-item">
                                <a class="dropdown-item px-0 py-1" href="#">Настройки</a>
                            </router-link>
                            <router-link to="/switch-language" tag="div" class="nav-item">
                                <a class="dropdown-item px-0 py-1" href="#">Помощь</a>
                            </router-link>
                            <router-link to="/switch-language" tag="div"
                                         class="nav-item border-top">
                                <a class="dropdown-item px-0 py-1" href="#">Выйти</a>
                            </router-link>
                        </div>
