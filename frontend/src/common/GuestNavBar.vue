        ...
        <div class="container-fluid px-0 py-0 --w-100 my-0">
            <div class="row w-100 px-0 mx-auto">
                <div class="col-4 col-sm-3 col-md-2 d-flex align-items-center">
                    <router-link to="/" tag="a" class="navbar-brand mr-auto">
                ...
                <div class="col-12 order-1 order-md-0 col-md-7 d-flex align-items-center">
                    <NavBarSearch></NavBarSearch>
                </div>
                <div class="col-5 col-md-3 px-md-0 mr-md-0 ml-auto">
