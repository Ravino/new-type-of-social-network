<template>
    <div id="accountSettingsMain" class="plz-account-settings-main bg-white-br20 plz-mb20 container-fluid">
        <form class="m-3 pb-2">
            ...
            <div class="form-group row mb-0 border-bottom">
                <label class="col-sm-6 col-md-6 col-lg-4 col-xl-4 col-form-label text-secondary">Семейной
                    положение</label>
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <span class="form-control-plaintext d-inline-block w-auto">В активном поиске</span><i
            ...
            <div class="form-group row mb-0 border-bottom">
                <label for="birthDate" class="col-sm-6 col-md-6 col-lg-4 col-xl-4 col-form-label text-secondary">Дата
                    рождения</label>
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <input v-show="isEdit.birthDate"
                           v-model="model.birthDate"
                           @keydown="accountKeyDownCheck($event, `birthDate`)"
                           @blur="accountFieldBlur($event, `birthDate`)"
                           type="text"
                           id="birthDate"
                           class="form-control-plaintext"
                           ref="birthDate"
                    ...
                    <input v-show="!isEdit.birthDate"
                           ...
                           type="date"
                           class="form-control-plaintext"
                           ref="birthDateDisplay"
                           readonly/>
                </div>
                <div class="col-2 d-sm-none d-md-none d-lg-flex d-xl-flex">
                    <button type="button"
                            class="btn btn-link text-body"
                            @click.stop.prevent="isEdit.birthDate ? finishFieldEdit(`birthDate`) : startFieldEdit(`birthDate`)">
                        {{ isEdit.birthDate ? 'Сохранить' : 'Изменить' }}
                    </button>
                </div>
            </div>
            ...
            <div class="form-group row mb-0 --border-bottom d-sm-none d-md-none d-lg-flex d-xl-flex">
                ...
                <div class="col-2 d-sm-none d-md-none d-lg-flex d-xl-flex">
                    <button type="button"
                            class="btn btn-link text-body"
                            @click.stop.prevent="isEdit.city ? finishFieldEdit(`city`) : startFieldEdit(`city`)">
                        {{ isEdit.city ? 'Сохранить' : 'Изменить' }}
                    </button>
                </div>
            </div>
