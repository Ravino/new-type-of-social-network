<template>
    <div class="row plz-post-item mt-4 bg-white-br20 py-4">
        ...
        <div v-if="(post.images  &&  post.images.length>0)" class="col-12 px-4">
            <div class="post-pictures-list d-flex flex-row flex-nowrap justify-content-center align-items-start align-items-start align-content-start">
                <div v-for="(postPic, postPicIndex) in post.images" v-bind:key="postPicIndex"
                     class="post-picture-pic" :class="calcPostPicClass(postPic, postPicIndex)">
                    <img :src="postPic.path" :alt="postPic.name" class="post-picture-img" />
                </div>
            </div>
        </div>
...
methods: {
    calcPostPicClass(pic, pIndex){
        return {
            'post-picture-main': pIndex === 0,
            'mr-auto': pIndex === 0,
            'align-self-stretch': pIndex === 0,

            'post-picture-aux': pIndex > 0,
            'ml-auto': pIndex > 0,
            'align-self-start': pIndex > 0,
        }
    }
},
