        ...
        <form id="registrationForm" novalidate="novalidate">
            ...
            <div class="form-group" :class="{ '--has-error': $v.model.lastName.$error, '--has-success': !$v.model.lastName.$invalid }">
                ...
                <input v-model="model.lastName"
                       ...
                       type="text" class="lr-input form-control" id="lastName" ref="lastName" placeholder="Ваша фамилия" />
            ...
            <div class="form-group">
                <button id="btnRegistration" type="button" :disabled="$v.$invalid" @click="startRegistration()"
                        class="btn plz-btn plz-btn-primary">Регистрация</button>
            </div>
        </form>
    </div>
</template>
